...
def test_profile_formats():
    ...
    test_profiles = [
        OasisAgentProfile(
            ...
            country="Deutschland",
            profession="Student",
            interested_topics=["Technologie", "Bildung"],
        ...
        OasisAgentProfile(
            ...
            name="Offizielle Organisation",
            bio="Offizielles Konto der Organisation",
            persona="Dies ist ein offizielles institutionelles Konto, das offizielle Positionen kommuniziert.",
            karma=5000,
            friend_count=50,
            follower_count=10000,
            statuses_count=200,
            profession="Organisation",
            interested_topics=["Öffentliche Politik", "Bekanntmachungen"],
            source_entity_uuid="test-uuid-456",
            source_entity_type="Universität",
        ),
    ]
