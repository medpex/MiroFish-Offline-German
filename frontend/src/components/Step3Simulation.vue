    ...
    <div class="control-bar">
      <div class="status-group">
        ...
        <div class="platform-status twitter" :class="{ active: runStatus.twitter_running, completed: runStatus.twitter_completed }">
          <div class="platform-header">
            ...
            <span class="platform-name">Info-Marktplatz</span>
        ...
        <div class="platform-status reddit" :class="{ active: runStatus.reddit_running, completed: runStatus.reddit_completed }">
          <div class="platform-header">
            ...
            <span class="platform-name">Themen-Gemeinschaft</span>
      ...
      <div class="action-controls">
        ...
        >
          ...
          {{ isGeneratingReport ? 'Wird gestartet...' : 'Berichterstellung starten' }}
              ...
              <div class="card-body">
                ...
                <template v-if="action.action_type === 'REPOST'">
                  <div class="repost-info">
                    ...
                    <span class="repost-label">Geteilt von @{{ action.action_args?.original_author_name || 'Benutzer' }}</span>
                  </div>
                ...
                <template v-if="action.action_type === 'LIKE_POST'">
                  <div class="like-info">
                    ...
                    <span class="like-label">Beitrag von @{{ action.action_args?.post_author_name || 'Benutzer' }} geliked</span>
                  </div>
                ...
                <template v-if="action.action_type === 'FOLLOW'">
                  <div class="follow-info">
                    ...
                    <span class="follow-label">Folgt @{{ action.action_args?.target_user || action.action_args?.user_id || 'Benutzer' }}</span>
                  </div>
                </template>
                ...
                <template v-if="action.action_type === 'UPVOTE_POST' || action.action_type === 'DOWNVOTE_POST'">
                  <div class="vote-info">
                    ...
                    <span class="vote-label">Beitrag {{ action.action_type === 'UPVOTE_POST' ? 'positiv' : 'negativ' }} bewertet</span>
                  </div>
