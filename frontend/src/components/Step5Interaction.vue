        ...
        <div class="action-bar-header">
          ...
          <div class="action-bar-tabs">
            ...
            >
              ...
              <span>Chat mit Berichts-Agent</span>
            </button>
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent ? selectedAgent.username : 'Chat mit einem Individuum' }}</span>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Schnelle Chat-Version des Berichts-Agenten mit 4 professionellen Werkzeugen und vollem MiroFish-Gedächtnis</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Gleicht reale Keimdaten mit dem Simulationsumgebungszustand ab, kombiniert Global/Local-Memory-Mechanismen und bietet zeitübergreifende Tiefenattributionsanalyse</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">PanoramaSearch Panoramische Verfolgung</div>
                    <div class="tool-desc">Graphbasierter Breitensuche-Algorithmus, rekonstruiert Ereignisausbreitungspfade und erfasst die vollständige Informationsfluss-Topologie</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">GraphRAG-basierte sofortige Abfrageschnittstelle mit optimierter Indexierungseffizienz zum schnellen Extrahieren von Knotenattributen und diskreten Fakten</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">InterviewSubAgent Virtuelle Befragung</div>
                    <div class="tool-desc">Autonome Befragung mit parallelen Mehrrunden-Gesprächen mit Individuen der simulierten Welt, sammelt unstrukturierte Perspektivdaten und psychologische Zustände</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div v-if="chatTarget === 'agent' && selectedAgent" class="agent-profile-card">
            ...
            <div v-if="showFullProfile && selectedAgent.bio" class="profile-card-body">
              <div class="profile-card-bio">
                <div class="profile-card-label">Einführung</div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chatten Sie mit dem Berichts-Agenten, um den Berichtsinhalt tiefgreifend zu verstehen' : 'Chatten Sie mit simulierten Individuen, um deren Perspektiven kennenzulernen' }}
              </p>
            </div>
            <div 
          ...
          <div class="survey-setup">
            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">Umfrageziele auswählen</span>
              ...
              <div class="selection-actions">
                ...
                <button class="action-link" @click="clearAgentSelection">Zurücksetzen</button>
              </div>
            </div>
            ...
            <div class="setup-section">
              ...
              <textarea 
                ...
                class="survey-input"
                placeholder="Geben Sie die Frage ein, die Sie allen ausgewählten Zielen stellen möchten..."
                rows="3"
              ></textarea>
            </div>
...
const sendToAgent = async (message) => {
  if (!selectedAgent.value || selectedAgentIndex.value === null) {
    throw new Error('Bitte wählen Sie zuerst ein simuliertes Individuum aus')
  }
